// El usuario consulta la disponibilidad de una Habitacion segun el Nro.
Funcion search_room = room_search(i, hotel, room_request, room_number, bedrooms_number, availability_room)
...
// El usuario realiza una Reserva segun el Nro. de Habitacion y Personas
Funcion reservation_make = make_reservation(i, hotel, room_number, bedrooms_number, availability_room, room_request, people_number, entrance_date, exit_date, reservation)
...
Funcion reservation_delete = delete_reservation(i, hotel, room_request, room_number, reservation, availability_room)
	
	Escribir "¿Cual es el Nro. de Habitacion que quiere Cancelar? "; Leer room_request
	
	Para i = 1 Hasta reservation Con Paso 1 Hacer
		Si room_request = room_number[i] Entonces
...
Algoritmo Gestion_Reservas_Hotel_Refact
	Definir i, hotel, room_number, bedrooms_number, option_menu, room_request, room_reservation, people_number, reservation, cancel_reservation Como Entero
	...
	Repetir
		...
		Segun option_menu Hacer
			...
			Caso 2:
				...
				request = room_search(i, hotel, room_request, room_number, bedrooms_number, availability_room)
			...
			Caso 3:
				...
				// - Fecha de Entrada
				// - Fecha de Salida
				make = make_reservation(i, hotel, room_number, bedrooms_number, availability_room, room_reservation, people_number, entrance_date, exit_date, reservation)
				
			Caso 4:
				// Cancela Reserva Indicando:
				// - Nro de Habitacion reservado
				cancel = delete_reservation(i, hotel, room_reservation, room_number, reservation, availability_room)
